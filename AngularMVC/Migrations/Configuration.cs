        ...
        protected override void Seed(AngularMVC.Models.PeopleListDb context)
        {
            ...
            context.People.AddOrUpdate(
                new Person
                {
                    ...
                    Country = _db.Countries.First(x => x.CountryName == "Denmark"),
                    CountryId = _db.Countries.First(x => x.CountryName == "Denmark").CountryId,
                    ProfilePicture = _db.Images.First(x => x.ImageName == "Img1"),
                    ProfilePictureId = _db.Images.First(x => x.ImageName == "Img3").ImageId
                },
                new Person
                {
                    FirstName = "Jane",
                    ...
                    Country = _db.Countries.First(x => x.CountryName == "Denmark"),
                    CountryId = _db.Countries.First(x => x.CountryName == "Denmark").CountryId,
                    ProfilePicture = _db.Images.First(x => x.ImageName == "Img5"),
                    ProfilePictureId = _db.Images.First(x => x.ImageName == "Img5").ImageId
                },
                new Person
                {
                    FirstName = "Happy",
                    ...
                    Country = _db.Countries.First(x => x.CountryName == "Denmark"),
                    CountryId = _db.Countries.First(x => x.CountryName == "Denmark").CountryId,
                    ProfilePicture = _db.Images.First(x => x.ImageName == "Img3"),
                    ProfilePictureId = _db.Images.First(x => x.ImageName == "Img3").ImageId
                },
                new Person
                {
                    ...
                    Country = _db.Countries.First(x => x.CountryName == "Norway"),
                    CountryId = _db.Countries.First(x => x.CountryName == "Norway").CountryId,
                    ProfilePicture = _db.Images.First(x => x.ImageName == "Img4"),
                    ProfilePictureId = _db.Images.First(x => x.ImageName == "Img4").ImageId
                }
                );
            context.SaveChanges();
        }
